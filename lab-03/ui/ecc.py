...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(290, 40, 151, 31))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(50, 260, 61, 16))
        self.label_3.setObjectName("label_3")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(120, 130, 611, 87))
        self.txt_info.setObjectName("txt_info")
        self.txt_signature = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_signature.setGeometry(QtCore.QRect(120, 260, 611, 87))
        ...
        self.btn_genkeys.setGeometry(QtCore.QRect(320, 480, 93, 28))
